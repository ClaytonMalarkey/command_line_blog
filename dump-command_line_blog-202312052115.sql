...
INSERT INTO `posts` VALUES (1,1,'ass','hole'),(2,2,'bum','fart'),(3,3,'slit','pink'),(4,2,'hurt','now'),(5,4,'test','it');
...
INSERT INTO `users` VALUES (1,'me','ass','2222-12-12'),(2,'you','ass','2020-12-12'),(3,'her','ass','2021-12-12'),(4,'them','ass','2023-12-12');
...
BEGIN
    ...
    VALUES (client_id_param, content_param, title_param);
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `retrieve_all_posts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `retrieve_all_posts`()
BEGIN
...
-- Dump completed on 2023-12-05 21:15:33
